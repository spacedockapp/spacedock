...
public class CaptainsListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lv = (ListView) findViewById(R.id.captainsList);
        Universe universe = Universe.getUniverse();
        ArrayList<String> factions = universe.getAllFactions();
        SeparatedListAdapter headerAdapter = new SeparatedListAdapter(this);
        for (String s : factions) {
            ArrayList<Captain> factionCaptains = universe.getCaptainsForFaction(s);
            ArrayAdapter<Captain> adapter = new CaptainsAdapter(this,
                    R.layout.captain_list_row, factionCaptains);
    ...
    static class SeparatedListAdapter extends BaseAdapter
    {
